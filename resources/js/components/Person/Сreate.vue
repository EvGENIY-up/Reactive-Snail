   ...
   <div class="create-person">
        <div class="d-flex justify-content-center">
            ...
            <div class="modal-header">
                <h1 class="modal-title fs-4">Добавление водителя</h1>
            </div>
            <form>
                <div class="modal-body">
                    ...
                    <div class="large-12 medium-12 small-12 cell">
                        <label class="d-flex">
                            <input class="w-75" type="file" id="fileBook" name="fileBook" accept=".jpg, .jpeg, .png" ref="fulpoad" @change="onFileChange"/>
                ...
                <div class="d-flex justify-content-between">
                    <router-link to="/person"><p class="mt-2 cu-p fs-5">Вернуться назад</p></router-link>
        ...
        createPerson() {
            axios.post('/api/people', {
                ...
                if (response.status === 200) {
                    this.noError = true
                    this.hasError = false
                    this.message = 'Вы успешно добавили водителя';
                }
            }).catch(error => {
                if (error.response) {
                    this.noError = false
